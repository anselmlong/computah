...
The public site is [computah2.anselmlong.com](https://computah2.anselmlong.com); the [demo recording](https://youtu.be/WGbVYat8Lmg) is linked from its homepage and public documentation.
